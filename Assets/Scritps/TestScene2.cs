...
public class TestScene2 : MonoBehaviour
{
    ...
    {
        string weirdString = "超链接文字超链接124啊手动阀English Test Generic File[e-1][e-2]一段[h-超链接文字超链接文字超链接文字超链接文字超链接文字-89]，一个[e-1][e-2]一个[e-1][e-2]一个[e-1][e-2]一个[e-1][e-2]一个[e-1][e-2]一个[e-1][e-2]一个[e-1][e-2]一个[e-1][e-2]，外加一张[i-aaa]和一张[i-bbb]";
