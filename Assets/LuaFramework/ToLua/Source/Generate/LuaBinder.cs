...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.RegFunction("NetworkEventHandler", NetworkEventHandler);
		L.BeginModule("Protocols");
		Protocols_NetworkControllerWrap.Register(L);
		Protocols_ProtoBodyWrap.Register(L);
		Protocols_ProtocolWrap.Register(L);
		Protocols_ProtoIDWrap.Register(L);
		L.BeginModule("ProtoBody");
		...
		L.RegFunction("Action_System_IO_Stream_Protocols_ProtoBody", System_Action_System_IO_Stream_Protocols_ProtoBody);
	...
	static int NetworkEventHandler(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<NetworkEventHandler>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<NetworkEventHandler>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_System_IO_Stream_Protocols_ProtoBody(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<System.IO.Stream,Protocols.ProtoBody>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<System.IO.Stream,Protocols.ProtoBody>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
