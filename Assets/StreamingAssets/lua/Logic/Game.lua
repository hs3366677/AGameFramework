...
require "Controller/TestProtocolCtrl"

require "Controller/TestProtocolCtrlNew"
...
function Game.OnInitOK()
   ...
   --[[  this.test_class_func();
    ...
    --if ctrl ~= nil and AppConst.ExampleMode == 1 then
        --ctrl:Awake();
    --end
    print('LuaFramework InitOK22222222222222222222--->>>');
    local ctrl = CtrlManager.GetCtrl(CtrlNames.TestProtocol);
    if ctrl ~= nil and AppConst.ExampleMode == 1 then
        ctrl:Awake();
    end
