...
public static class CustomSettings
{
    ...
    {        
        ...
        _DT(typeof(NetworkEventHandler))
    };
    ...
    {                
        ...
        _GT(typeof(Protocols.NetworkController)),
        _GT(typeof(TestHelper)),
        _GT(typeof(Protocols.ProtoBody)),
        _GT(typeof(Protocols.Protocol)),
        _GT(typeof(Protocols.ProtoID)),
#if USING_DOTWEENING
