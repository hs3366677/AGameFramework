...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("testProtocol" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/NewUI");
    ...
    public static void BuildProtobufFile() {
        ...
        string dir = Application.dataPath + "/LuaFramework/Lua/3rd/pblua";//AppDataPath + "/Lua/3rd/pblua";
        paths.Clear(); files.Clear(); Recursive(dir);

        string protoc = Application.dataPath + "/protobuf-2.4.1/src/protoc.exe";
        string protoc_gen_dir = "\"" + Application.dataPath + "/protoc-gen-lua/plugin/protoc-gen-lua.bat\"";
