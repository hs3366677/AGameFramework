...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(NetworkEventHandler), factory.NetworkEventHandler);
		dict.Add(typeof(System.Action<System.IO.Stream,Protocols.ProtoBody>), factory.System_Action_System_IO_Stream_Protocols_ProtoBody);
		dict.Add(typeof(Protocols.ProtoBody.DeserializeFunc), factory.Protocols_ProtoBody_DeserializeFunc);
		...
		DelegateTraits<NetworkEventHandler>.Init(factory.NetworkEventHandler);
		DelegateTraits<System.Action<System.IO.Stream,Protocols.ProtoBody>>.Init(factory.System_Action_System_IO_Stream_Protocols_ProtoBody);
		DelegateTraits<Protocols.ProtoBody.DeserializeFunc>.Init(factory.Protocols_ProtoBody_DeserializeFunc);
		...
		TypeTraits<NetworkEventHandler>.Init(factory.Check_NetworkEventHandler);
		TypeTraits<System.Action<System.IO.Stream,Protocols.ProtoBody>>.Init(factory.Check_System_Action_System_IO_Stream_Protocols_ProtoBody);
		TypeTraits<Protocols.ProtoBody.DeserializeFunc>.Init(factory.Check_Protocols_ProtoBody_DeserializeFunc);
		...
		StackTraits<NetworkEventHandler>.Push = factory.Push_NetworkEventHandler;
		StackTraits<System.Action<System.IO.Stream,Protocols.ProtoBody>>.Push = factory.Push_System_Action_System_IO_Stream_Protocols_ProtoBody;
		StackTraits<Protocols.ProtoBody.DeserializeFunc>.Push = factory.Push_Protocols_ProtoBody_DeserializeFunc;
	...
	class NetworkEventHandler_Event : LuaDelegate
	{
		public NetworkEventHandler_Event(LuaFunction func) : base(func) { }
		public NetworkEventHandler_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Protocols.Protocol param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(Protocols.Protocol param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	bool Check_NetworkEventHandler(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(NetworkEventHandler), L, pos);
	}
	...
	class System_Action_System_IO_Stream_Protocols_ProtoBody_Event : LuaDelegate
	{
		public System_Action_System_IO_Stream_Protocols_ProtoBody_Event(LuaFunction func) : base(func) { }
		public System_Action_System_IO_Stream_Protocols_ProtoBody_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public void CallWithSelf(System.IO.Stream param0, Protocols.ProtoBody param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<System.IO.Stream,Protocols.ProtoBody> System_Action_System_IO_Stream_Protocols_ProtoBody(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<System.IO.Stream,Protocols.ProtoBody> fn = delegate(System.IO.Stream param0, Protocols.ProtoBody param1) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_System_IO_Stream_Protocols_ProtoBody_Event target = new System_Action_System_IO_Stream_Protocols_ProtoBody_Event(func);
			System.Action<System.IO.Stream,Protocols.ProtoBody> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_System_IO_Stream_Protocols_ProtoBody_Event target = new System_Action_System_IO_Stream_Protocols_ProtoBody_Event(func, self);
			System.Action<System.IO.Stream,Protocols.ProtoBody> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_System_IO_Stream_Protocols_ProtoBody(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<System.IO.Stream,Protocols.ProtoBody>), L, pos);
	}

	void Push_System_Action_System_IO_Stream_Protocols_ProtoBody(IntPtr L, System.Action<System.IO.Stream,Protocols.ProtoBody> o)
	{
		ToLua.Push(L, o);
	}

	class Protocols_ProtoBody_DeserializeFunc_Event : LuaDelegate
	{
		public Protocols_ProtoBody_DeserializeFunc_Event(LuaFunction func) : base(func) { }
		public Protocols_ProtoBody_DeserializeFunc_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public Protocols.ProtoBody CallWithSelf(System.IO.Stream param0, System.Type param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	bool Check_Protocols_ProtoBody_DeserializeFunc(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(Protocols.ProtoBody.DeserializeFunc), L, pos);
	}
